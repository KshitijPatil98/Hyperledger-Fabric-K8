...
export ${ORGNAME_ALL_UPPER}_CA=${PWD}/organizations/peerOrganizations/${ORGNAME_ALL_LOWER}.${PROJECT_NAME}.com/tlsca/tlsca.${ORGNAME_ALL_LOWER}.${PROJECT_NAME}.com-cert.pem
...
infoln "Let us query the  chaincode on peer0 of ${ORGNAME_ALL_LOWER}..."
queryInstalled 0

## approve the definition for org1
infoln "Let us approve the definition for chaincode on peer0 of ${ORGNAME_ALL_LOWER}..."
approveForMyOrg 0
