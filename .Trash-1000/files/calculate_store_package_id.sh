...
source ${PWD}/scripts/channel_scripts/oyur/utils.sh
...
# import utils
.  ${PWD}/scripts/channel_scripts/oyur/envVar_cli.sh
.  ${PWD}/scripts/channel_scripts/oyur/oyurchannel/ccutils.sh
...
sed -e "s/\${PACKAGE_ID}/${PACKAGE_ID}/g" \
        ${PWD}/skincare_cc_files/oyur/skincare.env > ${PWD}/skincare_cc_files/oyur/skincare_temp.env

mv "${PWD}/skincare_cc_files/oyur/skincare_temp.env" "${PWD}/skincare_cc_files/oyur/skincare.env"
