...
sudo chmod +x ${PWD}/skincare_script_files/channel_scripts/${ORGNAME_ALL_LOWER}/${CHANNELNAME}/install_approve_commit_query.sh
bash ${PWD}/skincare_script_files/channel_scripts/${ORGNAME_ALL_LOWER}/${CHANNELNAME}/install_approve_query.sh $CC_NAME $CC_SRC_PATH $CC_VERSION $CC_SEQUENCE $CC_COLL_CONFIG
