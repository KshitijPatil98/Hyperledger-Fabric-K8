...
source ${PWD}/scripts/channel_scripts/lab/utils.sh
...
# import utils
.  ${PWD}/scripts/channel_scripts/lab/envVar_cli.sh
.  ${PWD}/scripts/channel_scripts/lab/oyurchannel/ccutils.sh
...
sed -e "s/\${PACKAGE_ID}/${PACKAGE_ID}/g" \
        ${PWD}/skincare_cc_files/lab/skincare.env > ${PWD}/skincare_cc_files/lab/skincare_temp.env

mv "${PWD}/skincare_cc_files/lab/skincare_temp.env" "${PWD}/skincare_cc_files/lab/skincare.env"
