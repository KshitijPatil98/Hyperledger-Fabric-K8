...
joinChannel() {
  ...
  setGlobals $PEER
	...
	cat log.txt
	verifyResult $res "After $MAX_RETRY attempts, peer${ORG} of oyur has failed to join channel '$CHANNEL_NAME' "
}



## Join all the peers to the channel
infoln "Joining peer0 of oyur to the channel..."
joinChannel 0
infoln "Joining peer1 of oyur to the channel..."
joinChannel 1
